...
- **`CLAUDE.md`** — global rules applied to every project: commit discipline, self-documenting code, single responsibility, DRY. Both runtimes read this one file, Claude Code through `~/.claude/CLAUDE.md` and Codex through `~/.codex/AGENTS.md`.
